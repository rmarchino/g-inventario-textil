...
const createProductoValidator = [
    ...
    check('descripcion', 'Error en el campo descripcion')
        .isString().withMessage('El tipo de dato debe de ser estring')
        .isLength({ min: 10 }).withMessage('El descripcion debe tener mínimo 10 caracteres'),
        
    check('precio', 'Error en el campo precio')
        .isNumeric().withMessage('El tipo de dato debe ser numérico')
        .notEmpty().withMessage('precio no debe de estar vacío'),

    check('stock', 'Error en el campo stock')
        .isNumeric().withMessage('El tipo de dato debe ser numérico')
        .isInt().withMessage('Tipo de dato debe de ser entero')
        .notEmpty().withMessage('stock no debe de estar vacío'),

    check('categoria', 'Error en el campo categoria')
        .isInt().withMessage('Tipo de dato debe de ser entero')
        .notEmpty().withMessage('categoria no debe de estar vacío'),
